...
/**
 * Das Atom enthaelt den Wahrheitswert der atomaren Aussage und den Namen des
 * repraesentierten Subjekts. Es erbt direkt von der Formel, ist also kein
 * Konnektor und stellt damit das Ende jeder auswerten()-Kette dar. Es wird als
 * Großbuchstabe in der Formel dargestellt.
 * 
 * @author Flo
 *
 */
